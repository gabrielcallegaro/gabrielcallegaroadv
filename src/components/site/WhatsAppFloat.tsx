...
export function WhatsAppFloat({ href = WHATSAPP_URL }: { href?: string } = {}) {
  return (
    <WhatsAppLink
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-[var(--whatsapp)] px-5 py-4 text-primary-foreground shadow-elegant transition-smooth hover:scale-105"
    >
